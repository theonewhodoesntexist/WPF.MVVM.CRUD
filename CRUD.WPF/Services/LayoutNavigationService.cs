...
namespace CRUD.WPF.Services
{
        ...
        where TViewModel : ViewModelBase
    {
        ...
        {
            INavigationService dashboardNavigationService = _navigationManager.DashboardNavigationService();
            INavigationService recordsNavigationService = _navigationManager.RecordsNavigationService();
            INavigationService accountNavigationService = _navigationManager.AccountNavigationService();
            INavigationService loginNavigationService = _navigationManager.LoginNavigationService();
